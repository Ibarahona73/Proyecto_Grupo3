...
public class PerfilFragment extends Fragment {
    ...
    Button btnUpdate, btnChangePassword, btnDelete,btnLogout,btnphoto;
    ...
    private void logout(@NonNull View v) {
        ...
        JsonObjectRequest logoutRequest = new JsonObjectRequest(Request.Method.POST,
                ...
                response -> {
                    try {
                        if (response.getBoolean("status")) {
                            // Solicitud de cierre de sesión exitosa , eliminar el token localment, enviarlo al login ,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Log.d("CameraPermission", "requestCode: " + requestCode);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("CameraActivityResult", "requestCode: " + requestCode);
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            Log.d("CameraActivityResult", "Image captured successfully");
